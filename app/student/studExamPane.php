                ...
                <div class="primary-col">
                   ...
                   <div class="container">
                       ...
                       <div class="col-md-12 pl-0">
                            <ul class="staff-menu">
                            <li><a class="load-url" href="findMyExam.php"><i class="fa fa-eraser fa-fw" aria-hidden="true"></i> Find Result</a></li>
                            <li><a class="load-url" href="viewMyExam.php"><i class="fa fa-bolt fa-fw" aria-hidden="true"></i> Current</a></li>
                            </ul>
                            <hr class="mt-2">                
                       </div>
                       <!--inner div  -->
