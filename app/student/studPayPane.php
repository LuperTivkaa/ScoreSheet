                ...
                <div class="primary-col">
                   ...
                   <div class="container">
                       ...
                       <div class="col-md-12 pl-0">
                            <ul class="staff-menu">
                            <li><a class="load-url" href="findMyPayments.php"><i class="fa fa-eraser fa-fw" aria-hidden="true"></i> Find Payment</a></li>
                            <li><a class="load-url" href="currentPayments.php"><i class="fa fa-bolt fa-fw" aria-hidden="true"></i> Current Payment(s)</a></li>
                            <li><a class="load-url" href="allPayments.php"><i class="fa fa-bolt fa-fw" aria-hidden="true"></i> </a></li>
                            </ul>
                            <hr class="mt-2">                
                       </div>
                       <!--inner div  -->
