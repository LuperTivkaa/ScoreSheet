...
?>
              ...
              <h4 class="right-menu-header ">Create New Subject</h4>
              <div class="row">
            ...
            <label for="subject">Subject Name:</label>
              ...
              <h4 class="right-menu-header text-xs-center mt-3">Add Subject to Class</h4><small>Select subject and specify class to add subject to. Click <i class="fa fa-refresh fa-fw reload" aria-hidden="true"></i> to load subjects.</small>
              </div>
              </div>
