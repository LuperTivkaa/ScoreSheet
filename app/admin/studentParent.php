...
<!--<div class="col-md-3"></div>-->
    <div class="col-md-12"><h6 class="right-menu-header text-xs-center">Student - Parent Information</h6></div>
<!--<div class="col-md-3"></div>-->
    </div>
...
<div class="mb-3">
    <div class="form-group col-md-6 margin-bottom-sm">
                ...
                <?php 
                    $newStudent->loadNewStudent($clientid);
                  ?>
                </select> 
              </div>
              <hr>
    ...
    <div class="row">
            ...
            <div class="form-group col-md-4">
             ...
             <div class="form-group col-md-3">
              ...
              <button class="submit btn btn-primary" id="add-parent-info">Add Parent</button>