...
<!--<div class="col-md-3"></div>-->
    <div class="col-md-12"><h6 class="right-menu-header text-xs-center mt-3">Previous Class</h6></div>
<!--<div class="col-md-3"></div>-->
    ...
    <div class="row">
            <div class="form-group col-md-4">
              ...
              <button class="submit btn btn-primary" id="assign-admission-no">Display Student(s)</button>
