...
<li><a class="load-url" href="annualSubjectPosition.php"><i class="fa fa-eye" aria-hidden="true"></i>
Annual Subject Position </a></li>

 <li><a class="load-url" href="processAnnualResult.php"><i class="fa fa-eye" aria-hidden="true"></i>
 Annual Position </a></li>
 <li><a class="load-url" href="viewAnnualResult.php"><i class="fa fa-eye" aria-hidden="true"></i>
 Terminal Result Summary</a></li>
 <li><a class="load-url" href="viewYearlyResult.php"><i class="fa fa-eye" aria-hidden="true"></i>
 Annual Result Summary</a></li>             
                            </ul>
                            <hr class="mt-2">                
                       </div>
                       <!--inner div  -->
